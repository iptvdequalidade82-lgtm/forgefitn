...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "FORGEFIT" },
      { title: "FORGEFIT — Área de conteúdo" },
      {
        name: "description",
        content:
          "Área de conteúdo ForgeFit: biblioteca de exercícios, cronograma semanal, planilhas, receitas e desafio de 24 dias.",
      },
