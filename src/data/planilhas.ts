...
export const planilhas: Planilha[] = [
  {
    ...
    local: "",
    quantidadeDias: "",
    descricao: "Base usada nas recomendações FORGEFIT, também disponível no formato original.",
  ...
  },
  {
    ...
    local: "",
    quantidadeDias: "",
    descricao: "Base de exercícios e alongamentos para criar uma recomendação ajustável.",
